...
const Ricky = () => {
  ...
  return (
    <>
      ...
      <h1 style={{ fontFamily: "fantasy", fontSize: "60px", textAlign: "center", fontWeight: "300" }}>The Rick and Morty API</h1>
              ...
              <Grid size={6}>
                ...
                <Grid container spacing={0} sx={{ overflow: "hidden", borderRadius: "15px", backgroundColor: "rgb(39, 43, 51)" }}>
                  ...
                  <Grid size={7} sx={{ padding: "13.5px" }}>
                    ...
                    <Link sx={{ textDecoration: "none", fontWeight: "700", color: "white", fontSize: "22px", ":hover": { color: "rgb(255, 152, 0)" } }}><h2 style={{ margin: "0", fontWeight: "800" }}>Antenna Morty</h2></Link>
                    <span style={{ listStyle: "circle", display: "block", fontWeight: "500" }}><CircleIcon sx={{ color: "#55CC44", fontSize: "12px" }} /> Alive - Human</span>

                    <span style={{ marginTop: "20px", listStyle: "circle", display: "block", fontWeight: "500", color: "#9E9E9E" }}>Last known location:</span>
                    <Link sx={{ textDecoration: "none", color: "white", fontSize: "19px", ":hover": { color: "rgb(255, 152, 0)" } }}><h4 style={{ margin: "0", fontWeight: "400" }}>Citadel of Ricks</h4></Link>

                    <span style={{ marginTop: "20px", listStyle: "circle", display: "block", fontWeight: "500", color: "#9E9E9E" }}>First seen in:</span>
                    <Link sx={{ textDecoration: "none", color: "white", fontSize: "18px", ":hover": { color: "rgb(255, 152, 0)" } }}><h4 style={{ margin: "0", fontWeight: "400" }}>Close Rick-counters of the Rick Kind</h4></Link>
                  </Grid>
